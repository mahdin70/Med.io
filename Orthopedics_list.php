...
<?php
			...
			$sql = "SELECT ID,name, email, age, gender, Instituitional_Background, department,Phone_number FROM doctor where Approved=1 and department='Orthopedics'";
